...
Color btnBgColor;
    /**
     * Creates new form viewPassbookPage
     */
    ...
    public viewPassbookPage(String username) {
        ...
        viewPassbookPanel.setBackground(activeColor);
        ...
        logoutPanel.setBackground(exitColor);
            ...
            //mainPanel content
        passbook_tab.setBackground(mainPanelBgColor);
        passbook_tab.setForeground(labelColor);
    }
    /**
    ...
    private void initComponents() {
        ...
        viewPassbookPanel.setBackground(new java.awt.Color(97, 34, 21));
        ...
        passbook_tab.setBackground(new java.awt.Color(143, 125, 122));
        passbook_tab.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
...
passbook_tab.setForeground(labelColor);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewPassbookPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewPassbookPage().setVisible(true);
            }
        });
    }
